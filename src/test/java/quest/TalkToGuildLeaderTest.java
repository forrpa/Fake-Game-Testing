...
class TalkToGuildLeaderTest {
    ...
    void playerMeetsEndRequirementsForTalkToGuildLeaderQuest() {
        Player player = new Player("Healer", "Orc", 200, 1000);
    ...
    void tankGetsCorrectReward() {
        Player player = new Player("Healer", "Orc", 250, 1000);
    ...
    void damageGetsCorrectReward() {
        Player player = new Player("Healer", "Orc", 500, 1000);
    ...
    void nonTankHumanGetsCorrectReward() {
        Player player = new Player("Healer", "Human", 200, 1000);
